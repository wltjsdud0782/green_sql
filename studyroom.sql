...
ALTER TABLE STUDYROOM_COMMENT CHANGE COMMENT_WIRTER COMMENT_WRITER VARCHAR(20);
ALTER TABLE STUDYROOM_COMMENT CHANGE COMMET_DATE COMMENT_DATE DATETIME DEFAULT CURRENT_TIMESTAMP;
